...
ItemScore.SkillNames = { -- gets trimmed in a moment										-- needs checking
	...
	DUALWIELD = {id=118,	enUS="Dual Wield",		deDE="Beidhändigkeit",		esES="Empuñadura dual",		esMX="Empuñadura dual",		frFR="Ambidextrie",		itIT="Dual Wield",		ptBR="Empunhar Duas Armas",	ruRU="Бой двумя руками",		koKR="쌍수 무기",		zhCN="双武器",	zhTW="雙持",	},		      
