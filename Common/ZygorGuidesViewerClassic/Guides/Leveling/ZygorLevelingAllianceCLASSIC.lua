...
accept Encrypted Letter##511 |goto 48.92,41.61 |only Human Rogue
...
turnin Encrypted Letter##511 |goto 50.32,39.92
|only if Human Rogue
step
...
stickystop "Collect_Torn_Murloc_Fins"
step
...
step
Enter the building |goto 71.60,39.93 < 10 |walk
talk Harry Burlguard##6089
|tip Inside the building.
turnin A Warrior's Training##1638 |goto 74.25,37.26
accept Bartleby the Drunk##1639 |goto 74.25,37.26
|only if Human Warrior
step
talk Bartleby##6090
...
|only if Human Warrior
step
Enter the building |goto 29.15,74.18 < 10 |walk
talk Gakin the Darkbinder##6122
|tip Downstairs inside the building.
turnin Gakin's Summons##1685 |goto 25.26,78.56
accept Surena Caledon##1688 |goto 25.26,78.56
|only Human Warlock
step
...
Enter the Deeprun Tram |goto 63.92,8.20 > 2000 |c |q 433
step
_Inside Deeprun Tram:_
Ride the Tram
|tip Ride the Deeprun Tram from Stormwind City to Ironforge.
Click Here After Riding the Tram |confirm |q 433
step
_Inside Deeprun Tram:_
talk Monty##12997
...
step
_Inside Deeprun Tram:_
Enter Ironforge |goto Ironforge 76.51,51.12 < 2000 |noway |c |q 433
step
...
accept In Defense of the King's Lands##217 |goto Loch Modan 22.07,73.12
step
...
kill 10 Stonesplinter Trogg##1161 |q 217/1 |goto 32.51,73.25
step
label "Kill_Stonesplinter_Scouts"
kill 10 Stonesplinter Scout##1162 |q 217/2 |goto 32.51,73.25
step
Follow the path |goto 30.64,69.80 < 20 |only if walking
Follow the road down |goto 27.64,65.84 < 30 |only if walking
talk Mountaineer Cobbleflint##1089
turnin In Defense of the King's Lands##217 |goto 22.07,73.13
step
...
|tip Ressurect at the Spirit Healer near Menethil Harbor.
|tip This is much easier and faster than running all the way through the Wetlands, dying repeatedly.
Ressurect at the Spirit Healer Near Menethil Harbor |goto Wetlands 11.02,43.79 < 50 |noway |c |q 983 |future
step
...
Follow the path |goto 44.36,60.26 < 10 |walk
Continue following the path |goto 45.29,60.09 < 10 |walk
kill Rageclaw##7318 |q 2561/2 |goto 45.58,58.42
...
step
talk Mydrannul##4241
accept Nessa Shadowsong##6344 |goto Darnassus 31.90,56.37
|only if NightElf
step
talk Rellian Greenspyre##3517
turnin Rellian Greenspyre##922 |goto 38.19,21.63
step
Enter the building |goto 35.46,10.59 < 10 |walk
...
collect 12 Lunar Fungus##15851 |q 6123/1 |goto 43.07,45.55
...
kill Harvest Watcher##114+
collect 5 Flask of Oil##814 |q 103/1 |goto 53.89,32.26 |future
You can find more around [51.03,22.94]
step
...
step
Swim through the underwater boat window |goto 39.86,27.15 < 3 |walk
...
collect Bathran's Hair##5437 |q 1010/1 |goto 30.44,24.05
You can find more around: |notinsticky
[31.75,22.70]
[32.29,21.79]
step
