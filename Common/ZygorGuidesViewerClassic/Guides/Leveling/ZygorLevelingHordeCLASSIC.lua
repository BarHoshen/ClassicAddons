...
accept Finding the Antidote##813 |goto 47.24,53.59
step
Follow the path |goto 52.50,85.13 < 15 |only if walking
Leave Orgrimmar |goto 49.10,94.75 < 20 |only if walking
kill Venomtail Scorpid##3127+
collect 4 Venomtail Poison Sac##4886 |q 813/1 |goto Durotar 44.51,19.31
...
Follow the path |goto 52.34,29.37 < 20 |c |q 869 |future
step
talk Zargh##3489
...
step
Kill enemies around this area
Reach Level 18 |ding 18 |goto 53.04,33.69
You can find more around: |notinsticky
[54.18,36.03]
[56.14,39.05]
[57.67,38.41]
...
collect 8 Altered Snapjaw Shell##5098 |goto 55.53,42.70
step
Kill enemies around this area
...
step
Kill enemies around this area
Reach Level 21 |ding 21 |goto 65.74,30.02
You can find more around [68.31,35.72]
step
talk Apothecary Renferrel##1937
...
step
Run up the stairs |goto 81.18,15.87 < 7 |only if walking
...
step
Kill enemies around this area
Reach Level 25 |ding 25 |goto 44.88,78.18
You can find more around: |notinsticky
[44.96,75.36]
[47.81,75.13]
[47.18,79.21]
...
|tip Inside the building.
He can also be:
Inside the barn at [35.15,38.18]
...
[35.85,32.36]
step
Follow the path |goto 34.04,35.51 < 15 |only if walking
...
step
Escort Ruul from the Thistlefurs |q 6482/1 |goto 38.47,37.46
...
Enter the mine |goto 26.51,58.61 < 7 |walk
...
accept Free at Last##4904 |goto 37.95,26.46
step
Watch the dialogue
...
[36.84,37.54]
step
label "Reach_Level_31"
Kill enemies around this area
Reach Level 31 |ding 31 |goto 40.80,37.53
step
...
step
talk Cliffwatcher Longhorn##10537
turnin Grimtotem Spying##5064 |goto Thousand Needles 45.67,50.73
turnin Wanted - Arnak Grimtotem##5147 |goto Thousand Needles 45.67,50.73
step
...
Ride the elevator down |goto 46.72,48.26 < 10 |only if walking
Follow the road |goto 42.91,47.14 < 30 |only if walking
...
map Thousand Needles
path	follow loose;	loop;	ants curved;	dist 30
path	18.02,26.90		15.22,25.55		15.80,23.14		20.54,22.11
path	25.09,23.65		27.60,23.15		30.81,23.83		33.92,25.74
path	35.02,28.28		33.09,30.70		31.58,30.56		29.62,33.67
path	25.28,34.25		22.84,31.56
...
|tip You will have to fight, so be ready.
step
...
|tip A group of 3 wyverns once you reach the wide open area, so be ready.
|tip He eventually walks to this location.
...
Reach Level 34 |ding 34 |goto 75.19,56.17
step
...
|only if not Undead
step
Leave the building |goto 53.57,64.69 < 10 |c |q 1145
|only if not Undead
step
...
step
Follow the path up |goto 55.54,58.02 < 15 |only if walking
...
step
Follow the path |goto 56.14,56.90 < 20 |only if walking
...
step
Follow the road |goto 67.77,43.69 < 30 |only if walking
